...
public interface TweenModelBuilder<T> {
  ...
  //CHANGE - added a field in the constructor for the addOval and addRectangle methods to account
  //for layers.
   ...
   * @param zValue      the layer the shape is on
  ...
  TweenModelBuilder<T> addOval(
          String name,
          float cx, float cy,
          float xRadius, float yRadius,int zValue,
   ...
   *
   * @param name - represents the name of the shape to be scaled
   * @param fromSx - represents the shapes og x posn
   * @param fromSy - represents the shapes og y posn
   * @param toSx - represents the shapes new x posn
   * @param toSy - represents the shapes new y posn
   * @param startTime - represents the shapes start time
   * @param endTime - represents the shapes end time
   * @return the builder object
   */
